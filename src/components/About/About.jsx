...
const About = () => {
    return (
        <div className="flex md:flex-row flex-col-reverse sm:items-start md:items-center gap-10 mt-32">
            ...
            <div className='flex-grow'>
                <h3 className='text-center md:text-start text-5xl font-extrabold mb-8'>About Me <span className="text-pink-800 font-extrabold">_</span></h3>
